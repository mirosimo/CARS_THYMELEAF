...
import com.mirosimo.car_showroom.service.NodeService;
...
public class EmployeeController {
	...
	public String saveEmployee(@ModelAttribute("employee") Employee employee, 
		...
		employee.setEmployeeImg(employeeImg);
	...
	Employee assignCourseToEmployee(@PathVariable Long employeeId, @PathVariable Long courseId) {
		...
		TrainingCourse course = courseService.getCourseById(courseId);	
		emp.assignCourse(course);
